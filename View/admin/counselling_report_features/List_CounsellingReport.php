...
$List_CounselingReport = List_of_Counselling_Page();  ///path change
$Edit_CounselingReport_Page = Edit_CounsellingReport();   //path change
$Delete_CounsellingReportController = Delete_CounsellingReport_Controller();
...
<div class= "side-bar">
    ...
    <nav>
        <div class ="menu">
            ...
            <div class="item">
            <div class="item"><a href ="<?php echo $List_Patient; ?>"><img height="35px" width="35px" src="/Ideal_Health_Counselling_Management_System/View/images/patient_icon.png">Patient<i class ="fas-fa-angle-right dropdown"></i></a>
                <div class ="sub-menu">
                </div>
            </div>
            <div class="item">
    ...
    <table class="table">
        <thead class="table-dark">
           <tr>
               ...
               <th>Age</th>
               <th>Doctors Name</th>
               <th>Patients Ailment</th>
               <th>Doctors Remedy</th>
               <th>Doctor ID</th>
               <th>Patient ID</th>
               <th>Action</th>
           </tr>
        ...
        foreach ($data as $row){
            echo '<tr>';
            echo '<td>'.$row['id'].'</td>';
            echo '<td>'.$row['patients_name'].'</td>';
            echo '<td>'.$row['age'].'</td>';
            echo '<td>'.$row['doctor_name'].'</td>';
            echo '<td>'.$row['patients_ailment'].'</td>';
            echo '<td>'.$row['doctors_remedy'].'</td>';
            ...
            echo '
                                <form action="'.$Edit_CounselingReport_Page.'" method="post" class="mr-2"> 
            ...
            echo '
                                <form action="'.$Delete_CounsellingReportController.'" method="post">
                                    <div class="form-group">
                                        <input type="number" id="selected_id" name="selected_id" hidden="hidden" value="' . $row['id'] . '" />
