...
$Add_CounsellingReport_Controller = Add_CounsellingReport_Controller();
                ...
                <div class="col-12 col-lg-9 col-xl-7">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Add Counseling Registration Form</h3>
                            <form id="addDoctorForm" action="<?php echo $Add_CounsellingReport_Controller; ?>" method="post" onsubmit="">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-outline">
                                            <input type="text" id="counselling" name="counselling" class="form-control form-control-lg" />
