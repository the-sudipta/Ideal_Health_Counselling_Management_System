...
$List_Medical_lab =  List_Medical_Lab();  ///path change
$Edit_Medical_lab_Page = Edit_Medical_Lab();   //path change
$Delete_Medical_lab_Controller = Delete_Medical_lab_Controller();
...
<section class ="main" style ="margin-left:310px;">
    ...
    <table class="table">
        ...
        foreach ($data as $row){
            ...
            echo '<td>'.$row['lab_test_date_conducted'].'</td>';
            echo '<td>';
            echo '<div class="d-flex">'; // Use Bootstrap's d-flex class to create a flex container

            echo '
                                <form action="'.$Edit_Medical_lab_Page.'" method="post" class="mr-2"> 
            ...
            echo '
                                <form action="'.$Delete_Medical_lab_Controller.'" method="post">
                                    <div class="form-group">
                                        <input type="number" id="selected_id" name="selected_id" hidden="hidden" value="' . $row['id'] . '" />
