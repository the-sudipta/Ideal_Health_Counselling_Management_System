...
$Edit_DoctorController = Edit_DoctorController();
$List_DoctorController = List_Doctor();
$edit_id = -1;
if($_SERVER['REQUEST_METHOD'] === "POST"){
    $edit_id =  $_POST['selected_id'];
}
$doctor_data = findDoctorByID($edit_id);
...
<!--                            <h1>--><?php //echo $edit_id;?><!--</h1>-->
                            ...
                            <form id="addDoctorForm" action="<?php echo $Edit_DoctorController; ?>" method="post" onsubmit="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control form-control-lg" value="<?php if(isset($doctor_data['name'])){echo $doctor_data['name'];}else{echo "";}?>" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 d-flex align-items-center">
                                        <div class="form-outline datepicker w-100">
                                            <input type="text" class="form-control form-control-lg" id="department" name="department" value="<?php if(isset($doctor_data['department'])){echo $doctor_data['department'];}else{echo "";}?>"/>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="maleGender"
                                                   value="Male" <?php if(isset($doctor_data['gender']) && $doctor_data['gender'] === 'Male'){echo 'checked';} ?> />
                                            <label class="form-check-label" for="maleGender">Male</label>
                                        </div>

                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="femaleGender"
                                                   value="Female" <?php if(isset($doctor_data['gender']) && $doctor_data['gender'] !== 'Male'){echo 'checked';} ?>/>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-outline">
                                            <input type="text" id="counselling" name="counselling" class="form-control form-control-lg" value="<?php if(isset($doctor_data['consulting_room'])){echo $doctor_data['consulting_room'];}else{echo "";}?>"/>
                                            <label class="form-label" for="counselling">Counselling Room</label>
                                        </div>
                                    </div>

                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-outline">
                                            <input type="tel" name="phoneNumber" id="phoneNumber" class="form-control form-control-lg" value="<?php if(isset($doctor_data['mobile_number'])){echo $doctor_data['mobile_number'];}else{echo "";}?>" />
