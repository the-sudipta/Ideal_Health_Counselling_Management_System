...
$Edit_Patient_Page = Edit_Patient();//path change
$Delete_PatientController = Delete_PatientController();//path change
...
<section class ="main" style ="margin-left:310px;">
    ...
    <div class="d-grid gap-2">
        <a href="<?php echo $Add_Patient_Page; ?>" style="padding-bottom: 10px; padding-top: 10px; color: white; font-size: 20px;"  class="btn btn-primary" type="button"><b>Add Patient</b></a>
    </div>
    ...
    <table class="table">
        ...
        foreach ($data as $row){
            ...
            echo '<td>'.$row['patients_category'].'</td>';
            echo '<td>'.$row['patients_room'].'</td>';
            echo '<td>';
            echo '<div class="d-flex">'; // Use Bootstrap's d-flex class to create a flex container

            echo '
                                <form action="'.$Edit_Patient_Page.'" method="post" class="mr-2"> 
            ...
            echo '
                                <form action="'.$Delete_PatientController.'" method="post">
                                    <div class="form-group">
                                        <input type="number" id="selected_id" name="selected_id" hidden="hidden" value="' . $row['id'] . '" />
