...
include_once '../../../Model/patient_repo.php';

$Edit_PatientController = Edit_PatientController();
$List_PatientController = List_Patient();
$edit_id = -1;
if($_SERVER['REQUEST_METHOD'] === "POST"){
    $edit_id =  $_POST['selected_id'];
}
$patient_data = findPatientByID($edit_id);
...
<div class= "side-bar">
    ...
    <nav>
        <div class ="menu">
            ...
            <div class="item">
                <a href="<?php echo $Edit_PatientController; ?>" class ="sub-btn"><img height="35px" width="35px" src="/Ideal_Health_Counselling_Management_System/View/images/doctor_icon.png">Doctor<i class ="fas-fa-angle-right dropdown"></i></a>
                <div class ="sub-menu">
...
<!--                            <h1>--><?php //echo $edit_id;?><!--</h1>-->
                            ...
                            <form id="addDoctorForm" action="<?php echo $Edit_PatientController; ?>" method="post" onsubmit="">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                         <input type="text" id="id" name="id" hidden="hidden" class="form-control form-control-lg" value="<?php echo $edit_id;?>" />
                                            <input type="text" id="name" name="name" class="form-control form-control-lg" value="<?php if(isset($patient_data['name'])){echo $patient_data['name'];}else{echo "";}?>" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 d-flex align-items-center">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="date_of_birth" name="date_of_birth" value="<?php echo $patient_data['date_of_birth'];?>"/>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="single"
                                                   value="single" <?php if( $patient_data['marital_status'] === 'single'){echo 'checked';} ?> />
                                            <label class="form-check-label" for="single">single</label>
                                        </div>

                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="married"
                                                   value="married" <?php if(isset($patient_data['marital_status']) && $patient_data['marital_status'] === 'married'){echo 'checked';} ?>/>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-outline">
                                            <input type="text" id="address" name="address" class="form-control form-control-lg" value="<?php if(isset($patient_data['address'])){echo $patient_data['address'];}else{echo "";}?>"/>
                                    ...
                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-outline">
                                            <input type="tel" name="phoneNumber" id="phoneNumber" class="form-control form-control-lg" value="<?php if(isset($patient_data['mobile_number'])){echo $patient_data['mobile_number'];}else{echo "";}?>" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-outline">
                                            <input type="text" id="patient_category" name="patient_category" class="form-control form-control-lg" value="<?php if(isset($patient_data['patient_category'])){echo $patient_data['patient_category'];}else{echo "";}?>"/>
                                    ...
                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-outline">
                                            <input type="text" name="patients_room" id="patients_room" class="form-control form-control-lg" value="<?php if(isset($patient_data['patients_room'])){echo $patient_data['patients_room'];}else{echo "";}?>" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-outline">
                                            <input type="text" id="age" name="age" class="form-control form-control-lg" value="<?php if(isset($patient_data['age'])){echo $patient_data['age'];}else{echo "";}?>"/>
