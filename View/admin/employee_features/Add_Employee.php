...
$Add_EmployeeController = Add_EmployeeController();
                ...
                <div class="col-12 col-lg-9 col-xl-7">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form id="addDoctorForm" action="<?php echo $Add_EmployeeController; ?>" method="post" onsubmit="">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 d-flex align-items-center">
                                        <div class="form-outline datepicker w-100">
                                            <input type="text" class="form-control form-control-lg" id="salary" name="salary" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4 pb-2">
                                            <div class="form-outline">
                                                <input type="text" id="employee_office" name="employee_office" class="form-control form-control-lg" />
