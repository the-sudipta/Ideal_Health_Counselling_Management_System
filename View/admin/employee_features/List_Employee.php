...
$List_Employee = List_Employee();///path change
$Edit_Employee_Page = Edit_Employee();//path change
$Delete_EmployeeController = Delete_EmployeeController();
...
<section class ="main" style ="margin-left:310px;">
    ...
    <div class="d-grid gap-2">
        <a href="<?php echo $Add_Employee_Page; ?>" style="padding-bottom: 10px; padding-top: 10px; color: white; font-size: 20px;"  class="btn btn-primary" type="button"><b>Add Employee</b></a>
    </div>
    ...
    <table class="table">
        ...
        foreach ($data as $row){
            ...
            echo '<td>'.$row['employee_office'].'</td>';
            echo '<td>';
            echo '<div class="d-flex">'; // Use Bootstrap's d-flex class to create a flex container

            echo '
                                <form action="'.$Edit_Employee_Page.'" method="post" class="mr-2"> 
            ...
            echo '
                                <form action="'.$Delete_EmployeeController.'" method="post">
                                    <div class="form-group">
                                        <input type="number" id="selected_id" name="selected_id" hidden="hidden" value="' . $row['id'] . '" />
