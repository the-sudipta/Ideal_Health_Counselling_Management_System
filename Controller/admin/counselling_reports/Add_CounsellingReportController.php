...
$fullName = '';
$List_of_Counselling_Page = List_CounsellingReport();
$Add_Counselling_Page = Add_CounsellingReport();
...
if ($everythingOK && $everythingOKCounter === 0){
    ...
    if($data > 0){
        ...
        header("Location: {$List_of_Counselling_Page}");
    }else{
        header("Location: {$Add_Counselling_Page}");
    }
